...
namespace UserLibrary
{
    ...
    /// issue with credentials and google security prevent the feature from working
    /// disabled as of now
    /// </summary>
    public class EmailService
    {
        ...
        public void SendRecoveryEmail(string email, string newPassword)
        {
            ...
            message.From = new MailAddress("mailrelay.fhict.local");
            message.To.Add(new MailAddress("501909@student.fontys.nl")); //hardcoded: no users registered with actual emails
