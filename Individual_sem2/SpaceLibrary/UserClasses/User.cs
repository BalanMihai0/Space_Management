...
public abstract class User {
    ...
    //for editting user data on their own account
    public User(string firstName,  string email, string lastName, DateTime birthdate)
    {
        this.FirstName = firstName;
        this.Email = email;
        this.LastName = lastName;
    ...
    private static bool IsEmailValid(string email)
    {
        ...
        if (!isValidEmail)
        {
            ...
            //email also incorrect if it already exists, exception thrown from db
            return false;
        }
        return true;
    }
